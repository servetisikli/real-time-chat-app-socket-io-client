...
const ChatRoom = () => {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-gray-100 items-center justify-center">
      <div className="flex flex-col flex-grow overflow-y-auto p-4 bg-white shadow-md w-full max-w-4xl mx-auto mb-0 rounded-none sm:rounded-lg">
        ...
        <ul className="flex-grow overflow-y-auto mb-4 space-y-2">
          {messages.map((msg, index) => (
            ...
            >
              ...
              <span className="block text-xs sm:text-sm md:text-base break-words">
                {msg.message}
              </span>
            </li>
          ))}
